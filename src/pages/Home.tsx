...
const Home = () => {
  ...
  const alertas = [
    { tipo: "warning", mensagem: "Nível baixo no tanque BULK 02", tempo: "5 min" },
    { tipo: "info", mensagem: "Receita #1234 concluída com sucesso", tempo: "15 min" },
    { tipo: "warning", mensagem: "Manutenção programada Smart Calda A32", tempo: "1 hora" }
  ];
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{stat.variacao}</p>
                  </div>
